( function ( blocks, blockEditor, components, element, i18n, serverSideRender ) {
	...
	blocks.registerBlockType( 'wp-livescore/related-team-news', {
		edit: function ( props ) {
			...
			return el(
				...
				el(
					...
					el(
						...
						el( TextControl, {
							...
							onChange: function ( value ) {
								setAttributes( { teamId: parseInt( value, 10 ) || 0 } );
							}
						} ),
						el( RangeControl, {
					...
					el(
						PanelBody,
						{ title: __( 'Card Display', 'wp-livescore-la' ), initialOpen: true },
						el( ToggleControl, {
				...
				el( ServerSideRender, {
					block: 'wp-livescore/related-team-news',
