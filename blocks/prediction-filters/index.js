( function ( blocks, blockEditor, components, element, i18n, serverSideRender ) {
	...
	blocks.registerBlockType( 'wp-livescore/prediction-filters', {
		edit: function ( props ) {
			...
			return el(
				...
				el(
					...
					el(
						...
						el( ToggleControl, {
							label: __( 'Related team search', 'wp-livescore-la' ),
							checked: !! attributes.showTeamSearch,
							onChange: function ( value ) { setAttributes( { showTeamSearch: value } ); }
						} ),
						el( TextControl, {
				...
				el( ServerSideRender, { block: 'wp-livescore/prediction-filters', attributes: attributes } )
			);
		},
		save: function () {
			return null;
